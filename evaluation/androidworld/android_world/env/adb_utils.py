...
_PATTERN_TO_ACTIVITY = immutabledict.immutabledict({
    ...
    'audio recorder|audio recorder app|recorder|recorder app|audiorecorder': (
    ...
    'files|google files|google files app|files app|file manage|filesystem|documentsui': (
    ...
    'simple sms messenger|simple sms|messenger|simple messenger|messages|smsmessenger|sms': (
    ...
    'simple calendar pro|simple calendar|calendar|calendar app': (
        'com.simplemobiletools.calendar.pro/com.simplemobiletools.calendar.pro.activities.MainActivity'
    ),
    'simple gallery pro|simple gallery|gallery': (
    ...
    'simple draw pro|simple draw|draw': (
    ...
    'open tracks sports tracker|activity tracker|open tracks|opentracks|opentracks': (
...
def press_menu_button(
  ...
  """Issues an AdbRequest to press the MENU button.
  ...
  Returns:
    The adb response received after issuing the request.
  """
  logging.info('Attempting to press the MENU button')
  # KEYCODE_MENU is 82
  return issue_generic_request(
